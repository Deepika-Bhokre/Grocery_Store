...
public class Check_CustomerLogin extends HttpServlet {
	private static final long serialVersionUID = 1L;
  
    public Check_CustomerLogin() {
        super();
	...
	{
		String query = "select count(*) from Customer_Register where Password=\"" + pass +"\" and Email =\""+email+"\";";
